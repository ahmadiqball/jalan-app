  ...
  <div data-trip-header class="bg-white border-b border-sand-line sticky top-[68px] z-30">
    <div class="max-w-[1400px] mx-auto p-[18px_20px_0] md:p-[18px_32px_0] flex flex-wrap gap-[18px] items-start">
      ...
      <div class="flex gap-[10px] items-center text-[13px] font-600 mt-1 flex-wrap">
        ...
        <button v-if="owner" class="bg-white border border-sand-line2 text-ink-2 rounded-pill px-[14px] py-2 hover:border-teal-600 flex items-center gap-[6px]" @click="ui.shareOpen = true">
          <i class="i-lucide-share-2 text-[14px]" />
          {{ $t('app.header.share') }}
        </button>
